...
from robot_lab.assets.taili_quad import TAILI_QUAD_CFG  # isort: skip

@configclass
class TailiQuadRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        super().__post_init__()
        self.scene.robot = TAILI_QUAD_CFG.replace(prim_path='{ENV_REGEX_NS}/Robot')
        ...
        if self.__class__.__name__ == 'TailiQuadRoughEnvCfg':
